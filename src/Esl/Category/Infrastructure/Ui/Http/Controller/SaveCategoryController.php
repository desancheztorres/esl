...
use Arcmedia\Esl\Category\Application\Command\SaveCategoryHandler;
...
{
    public function __construct(private readonly SaveCategoryHandler $saveCategoriesHandler)
    {
    }
